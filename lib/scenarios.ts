...
Keep responses short (2-3 sentences), casual and warm. Ask follow-up questions to keep the conversation going.`,
      triggerRule: `Hidden trigger: If the user mentions "weekend", "project", or "promotion", set triggerActivated to true and include a surprising personal confession in bonusMessage.`,
...
Keep responses short (2-3 sentences), energetic and friendly. Ask about their running routine.`,
      triggerRule: `Hidden trigger: If the user mentions "marathon", "injury", "music", or "route", set triggerActivated to true and reveal your secret in bonusMessage.`,
...
Keep responses very short (1-2 sentences), slightly reserved but polite. The setting is a 30-second elevator ride.`,
      triggerRule: `Hidden trigger: If the user mentions "floor", "moving", "noise", or "party", set triggerActivated to true and reveal your secret in bonusMessage.`,
...
Keep responses conversational (2-3 sentences), sharp and curious. Ask probing but friendly questions.`,
      triggerRule: `Hidden trigger: If the user mentions "startup", "funding", "idea", or "investor", set triggerActivated to true and reveal your secret in bonusMessage.`,
